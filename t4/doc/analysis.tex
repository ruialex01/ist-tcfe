...
\[ 
\left\{\begin{matrix}
R_{B1}=XXXXXXXXXXXXXXXXXXXXXXXXXXX\\
R_{B2}=XXXXXXXXXXXXXXXXXXXXXXXXXXX\\
...
\begin{equation}
    ...
    \linebreak \frac{g_B+g_{m2}}{g_B+g_{e2}+g_{o2}+g_{m2}}\frac{(r_\pi||R_{B1}||R_{B2})}{(R_S+r_\pi||R_{B1}||R_{B2})}
    v_S(-g_m(R_C||r_o)
\end{equation}
...
XXXXXXXXXXXXXXXXXXXXXXXRUI; FALTA COLOCAR AS TABELAS E O GRÁFICO NO SÍTIO PRETENDIDOXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
