...
\begin{tabular}{|c||c|}
	...
	\input{octave_tab_current}
      ...
      \end{tabular}
      %\caption{The values of mesh currents $I_A$, $I_B$, $I_C$, $I_D$ and branch currents $I_A$, $I_B$, $I_3$, $I_4$, $I_5$, $I_C$, $I_D$ obtained through the aplication of the Node Voltage Method.}
...
\begin{center}
   ...
   \end{tabular}
   % \caption{The values of voltages $V_1$, $V_2$, $V_3$, $V_4$, $V_5$, $V_6$ and $V_7$ obtained through the aplication of the Node Voltage Method.}
\end{center}   
